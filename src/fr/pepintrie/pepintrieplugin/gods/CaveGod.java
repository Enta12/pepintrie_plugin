...
public class CaveGod extends God {
	...
	protected void getGoals() {
		...
		goals.get(1).add(new Goal("arborant mes temples de ma bannière"));
		//goal for size 3
		goals.get(2).add(new Goal("construisant un cimeti�re dans la montagne"));
		//goal for size 4
		...
		//goal for size 9
		goals.get(8).add(new Goal("construisant une cath�drale"));
		//goal for size 10
